...
public class ArrayEx {
    public static void main(String[] args) {
        ...
        System.out.println("intArray 의 0번 인덱스: " + intArray[0]);
        System.out.println("intArray: " + intArray); // [I@6bc7c054
        intArray[1] = 20;
        System.out.println("intArray: " + Arrays.toString(intArray)); // 실제로 변경이 됩니다. [10, 20, 25, 44, 55]

        char[] charArray;
        // scharArray= {'A', 'a'}; // compile error. 선언 시 초기화 안했을 때,
        ...
        doubleArray[2] = 0.7;
        // doubleArray[3] = 0.8;
        System.out.println("변경 후: " + Arrays.toString(doubleArray)); // 변경 후: [0.1, 0.5, 0.7]
        ...
        System.out.println("이차원 배열: " + matrix2[0][0]); // 0
        matrix2[0][0] = 1;
        matrix2[0][1] = 2;
        matrix2[1][0] = 3;
        matrix2[1][1] = 4;
...
//        System.arraycopy(originFruits, 0,newFruits, 0, originFruits.length-1);
        ...
        int[] rangeArray = Arrays.copyOfRange(originArray, 1, 4); // [2, 3, 4]
        ...
        System.out.println("Array.equals() (1 & 3)" + Arrays.deepEquals(deepArray1, deepArray3)); // true
        ...
        System.out.println("index of 60: " + index2); // -6 (존재하지 않을 때 -6이 고정되어 있는 값이 아닌 무작위 음수값 반환)
    }
}
