...
export default function LifeCyclePractice1() {
  const fakePosts = [
    {
      id: 1,
      title:
  ...
  axios({
    ...
    for (let item of response.data.slice(0, 10)) {
      // array.slice(0, 10) // 0 ~ 9 번 인덱스 가져오기
      axiosPosts.push(item);
    }
  });

  return (
    <>
      {/* <PostList postsList={fakePosts} /> */}
      <PostList postsList={axiosPosts} />
    </>
  );
}
