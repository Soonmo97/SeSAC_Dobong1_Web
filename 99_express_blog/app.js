...
/* 
    ...
    - view engine (ejs)
      ...
      pug, ejs, nunjucks, ... 등이 있지만 html과 과장 유사한것은 ejs
*/
...
/*
    미들웨더3. body-parser 설정 (express 내장 모듈)
    - req.body 기본적으로 undefined
    body-parse가 req.body를 서버측에서 사용할 수 있도록 파싱(parsing)해줌
*/

// true: queryString 모듈 사용, false: qs(좀 더 보완적) 모듈 사용
