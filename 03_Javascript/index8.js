...
console.log(now.getMonth() + 1, '월'); //월:  0 ~ 11
...
// 메소드
console.log(Math.min(1, 2, 3, 4, 5, 6, 7, 8, 9, -5, -7.5)); // 최소값
console.log(Math.max(2, 5, 4, 6, 10, 11, 5)); // 최대값
console.log(Math.ceil(5.155)); // 올림
console.log(Math.floor(5.655)); // 내림
console.log(Math.round(5.555)); // 반올림
// 0 <= x < 1
